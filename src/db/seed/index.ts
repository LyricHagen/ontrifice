  ...
  await db.insert(edges).values([
    {
      ...
      mathematicalSemantics: "tfidf_cosine=0.82; both contracts reference 'republican', 'democrat'",
      modelVersion: "tfidf-v1",
      evidence: {
        cosineSimilarity: 0.82,
        sharedEntities: ["republican", "democrat"],
        categoryMatch: true,
      },
    },
    {
      ...
      mathematicalSemantics: "granger_f=4.82 lag=14d p_adj=0.03 over 45 observations",
    ...
    },
    {
      ...
      confidence: "0.85",
      direction: "bidirectional",
      mathematicalSemantics: "P(A AND B) = 0; recession inversely correlated with equity performance",
      modelVersion: "structural-v1",
      evidence: {
        constraintType: "mutual_exclusion",
        collectivelyExhaustive: false,
        reason: "recession inversely correlated with equity performance",
      },
    },
  ]);
